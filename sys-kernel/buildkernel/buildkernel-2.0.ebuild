...
BASE_SERVER_URI="https://github.com/hijackeel"
HOMEPAGE="${BASE_SERVER_URI}/${PN}-hjkl"
SRC_URI="${BASE_SERVER_URI}/${PN}-hjkl/archive/refs/tags/${PV}.tar.gz"
